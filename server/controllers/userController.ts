            ...
            messages: [
                {
                    role: 'system',
                    content: `
                    You are a prompt enhancement specialist. Take the user's website request and expand it into a detailed comprhensive prompt that will help create the best possible website.
            ...
            messages: [
                {
                    ...
                    - Use Google Fonts CDN if neended for cutom fonts
                    - Use placeholder images from hhtps://placehold.co/600x400
                    - Use Tailwind gradient classes for beutiful backgrounds
                    - Make sure all buttons, cards, and components use Tailwind styling
                    
                    CRITICAL HARD RULES:
                    1. You MUST put ALL output into message.content.
