            ...
            messages: [
                {
                    ...
                    4. Using clear technincal terms

                    Return ONLY the enhanced request , nothing else. Keep it consice (1-2 sentences).`
                },
                {
                    role: 'user',
            ...
            messages: [
                {
                    ...
                    - Make sure it is a complete, standalone HTML document with Tailwind CSS
