        ...
        {loading ? (
          ...
          <div className='py-10 min-h-[80vh]'>
            <div className='flex items-center justify-between mb-12'>
              <h1 className='text-white text-3xl font-semibold'>Published Projects</h1>
          ...
          <div className='flex flex-col items-center justify-center h-[80vh]'>
            ...
            <button onClick={() => navigate('/')} className='text-white px-5 py-2 mt-5 rounded-md bg-indigo-600 active:scale-95 transition-all'>
              Create New
            </button>
